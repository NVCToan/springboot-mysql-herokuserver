				...
				<div class="col-xs-12">
					...
					<form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
						...
						<div class="form-group">
								...
								<%-- 
									Thay the cho 
									<input type="text" class="col-xs-10 col-sm-5" name = "title" value="${model.title} /> --%>
...
<script>
	$('#btnAddOrUpdateNew').click(function (e) {
	    e.preventDefault(); //Mặc định không có preventDefault thì sẽ tự động lấy tiếp tính từ url hiện tại => sai
	    var data = {}; // formData chỉ mới là data bên phía js, muốn dùng được để đẩy về server thì phải chuyển về để đưa vào function
	    var formData = $('#formSubmit').serializeArray(); /* Bước formData này giúp lấy ra mảng tất cả các field trong form mà không phải làm thủ công 
	    							(Ví dụ: vả content =  $('#').val())    
	    							Lưu ý là các field phải có name và name và id phải đặt giống với lớp DTO */
